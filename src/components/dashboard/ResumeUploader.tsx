...
import { processResume } from '../../../actions/resume.action';
...
export default function ResumeUploader({
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // OR we await it to show "Analyzing..." state. Let's await for better UX.
            await processResume(publicUrl);
